...
def plot_confusion_matrix(model, X_test, y_test):
    ...
    plt.title("Confusion Matrix for Naive Bayes Kaggle Data")
...
if __name__ == "__main__":
    ...
    # evaluate_naive_bayes(model, X_uoft, y_uoft)
    # plot_confusion_matrix(model, X_uoft, y_uoft)
    # plot_roc_curve(model, X_uoft, y_uoft)